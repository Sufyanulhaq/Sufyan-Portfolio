...
import { TrendingUp, Globe, FileText, Settings } from "lucide-react"
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Key SEO elements to optimize</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 bg-green-500 rounded-full"></div>
              <span className="text-sm">Meta descriptions set</span>
            </div>
            <div className="flex items-center gap-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Latest SEO improvements</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="text-center py-8">
              ...
              <p className="text-sm text-muted-foreground mt-2">
                SEO improvements will appear here
              </p>
            </div>
          </CardContent>
        </Card>
